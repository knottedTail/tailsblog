...
- [ ] calculate Alexander polynomial in $t$ (Cor 3.4 in paper written by 조경희 교수님, 김혁 교수님)

- [ ] obtain max coefficient(abolute value) and plot coefficient graphs for each polynomial(abs? no abs?).
