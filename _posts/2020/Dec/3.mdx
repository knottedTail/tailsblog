...
* FIR: Finite Impurse Response(=nonrecursive), IIR: Infinite Impurse Response(=recursive) (Digital) filter

* Digital filter <- __Trasnfer function__

# Schedule

* 1000 - 1025: 명-상 겸 조금 놀다.. 화장실

* 1025 - 1300: Update a module _database_. a class for PCG dataset is implemented.

* 1300 - 1510: 커피사먹고 knot 준비 / meeting w/ SeonHwa

* 1510 - 1730: 급미팅 + chat with  TaeJin

* 1730 - 2000: 세시간..? only for new pdecomp....??

* 2000 - 2100: 저녁

* 2100 - 2313: PCG preprocessing.. digital filter만 끝!


 PCG preprocessing (50Hz downsampling) -> save as image(length별 width 늘려서) + wavelet tf까지
