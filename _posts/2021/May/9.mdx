...
* 1100 - 1130: 출근(지각), 중간고사 클레임 처리

* 1130 - 1310: g_ij 데이터 정리, json import 안되는 부분 찾아 수정..

* 1310 - 1400: 스트레칭 + 스승의 날 선물 생각 중

* 1400 - 1530: 선물 초안 고름 + 투표

* 1530 - 1705: gij 마무리 + 수특1 중간고사 클레임 메일 답장

* 1705 - 1800: gij 마무리2(진)

* 1800 - 1910: 산책 + 운동화 맡기고 옴

* 1910 - 2020: ML vote 관련 둘러보다 지침

* 2020 - 2352: Hospital detection 으로 방향 돌려서 코드 짜는데... 시간을 쏟아부었구요
