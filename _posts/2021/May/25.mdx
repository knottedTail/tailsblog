...
* 1000 - 1020: 출근 / 이영민 선생님 만나 캠 문제 해결(...업데이트!)

* 1020 - 1200: dct noise 를 이용한 Denosing AE 만들기(관찰 및 DB편)

* 1200 - 1248: Denoising AE 만들기(모델편)

* 1248 - 1313: Denoising AE 만들기! 훈련 돌리는 중

* 1313 - 1337: 1차 결과 확인 (terrible :D)

* 1337 - 1448: 잠깐 쉴(?)겸 porti 적어둔거 리뷰 / AE 2차 확인(Not bad), 수정보다가 관상동맥 과제 미팅 잡힘

* 1448 - 1523: DAE(lead II) 수정(preprocess 하지 않은 원본을 baseline correction한 clean에 근사하기)

* 1523 - 1608: DAE 걸어두고 가우스 콜로퀴움 보러

* 1608 - 2024: 가우스 콜로퀴움(양자컴퓨팅 <-- 고등수학 / 산업 AI!(기절하느라 강의 놓침)) / DAE fine tuning

* 2024 - 2040: 한숨

* 2040 - 2240: Torsion! .. 하려다가 Reference app Mendeley + Papership 대신할 것 찾아보다.. 포기 (Papers ㅠㅠ)

* 2240 - 2334: $7(combinatorial invariance thm) -> $5(algebraic subdivision) -> $3(torsion of long exact sequence)
