...
* 1000 - 1025: 출근 + 인건비(국웅)변경 서명(100!! vvvvvvv)

* 1025 - 1225: 스승의 날 이벤트 조율 w/ 찬규 + 수학특강1 과제 문의 고민(4번 loopless) 하다가 문제 전체 스캔

* 1225 - 1255: 수경누나 장학금 얘기

* 1255 - 1400: Hospital detection 결과 정리

* 1400 - 1525: 스승의 날 선물 전달 + 도형이랑 잡담

* 1525 - 1605: Shellable 문의 보다 형주선배한테 물어보기 + 수다(extendable shellable)

* 1605 - 1640: Autoencoder ㄱ... 하려는데 오토가 자기 코드 보라고 + 수학특가ㅇ1 과제 문의 처리

* 1640 - 1700: autoencoder ... 말고 오토 코드 구경(Which region is interested for trained model? .. by model weights!)

* 1700 - 2011: 제주도 흑돼지

* 2011 - 2338: 노가리.. 하다 knot to do
