...
CSV파일에서 빠진 목록
 * HY/ECG1/2019-01-26/2019-02-14/ : 191개
 * HY/ECG1/2019-02-19-2/2019-02-25-2 : 172개
 * HY/ECG1/2019-03-05/20190516/ : 26개
 * HY/ECG1/2019-03-20-1/2019-03-11 : 191개
 * HY/ECG1/20190128/2019-02-19-1 : 175개
= 755

210308: 755개 모두 채워짐, total: 45535개

CSV에는 있으나 WAV에는 없음 : 4개, wave에 문제가 있어 추출할 수 없음
=> 총 755-4=751개 없음

중복데이터? : 있음
    * SEV/ECG1/421_20181114_1811211805.pdf & SEV/ECG2/421_20181114_1811211805.pdf
기존데이터와 중복 : 있음
    * complete_data/BundangSNU_hospital/10000502/10000502_20181130.xml
    * SNUB/ECG3/~2019.11.22/10000502_20181130.xml


## xml
1. description extractor
2. 10s data with description, save them

## data arrangement
.npz and .pkl

.npz = np.save(path, **db)
.pkl = pickle.save(db(array? dict?))

0. compatiblity check(done, some of HY data is missing in .csv file)
1. 
...
* 2300 - 0525: extract하는 함수들은 다 만듦

* 0525 - 0650: 좀 더 검사하다 전장 좀 뜀

* 0650 - 0826: 효율적인 구조 생각하고 테스트 후 계산 걸어둠
