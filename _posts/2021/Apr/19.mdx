...
Huge Voting System -> ACC=0.96 (!), 태진이형한테 확인 부탁한 상태라고 함, Dataset은 SNUB/SEV -> HY
...
* 1000 - 1230: 출근, knot 계산 디버깅하다 오토한테 걸림, 

* 1230 - 1830: 나빌레라, 잤다가 일어나니 저녁먹을 시간

* 1830 - 2000: 저녁차려먹고 출근

* 2000 - 2325: Torsion 공부! / 퇴근 
