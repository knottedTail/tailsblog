...
# Triangulablity of $3$-manifolds

Otto: Intuition on _topological_ manifold will fail in higher dimension. Drawings you can generate are already smooth/almost smooth (Lipschitz sense).

First solved by Moise in $1951$ and then by Bing in $1957$.

There was a suggestion from Kirby and Siebenmann which is a method used to solve the problem of triangulation in higher dimensions by themselves.

There are manifolds of higher dimensions which cannot be triangulated, __e.g.__ $E8$ manifold (what is it?)

__$E8$ manifold__

The _unique_ compact, simply connected topological $4$-manifold with intersectin form the $E_8$ lattice.

where $E_8$ lattice(Gosset lattice) is a special lattice in $\mathbb{R}^8$, characterized as the unique positive-definite, even, unimodular lattice of rank $8$.

The set of points in $E_8$ lattice, $\Gamma_8$, consists of integer/half-integer coordinates such that the sum of the eight coordinates is an even integer. __i.e.__
$$
\Gamma_8 = \{ (x_1, \cdots, x_8) \in \mathbb{R}^8 : \sum_i x_i \equiv 0 \pmod{2} \}
$$

__Proof..?__
[Affine structures in 3-manifold](https://www.jstor.org/stable/pdf/1969769.pdf)

Every $3$-manifold with boundary is triangulable. This is the solution of a problem of H. Poincaré $(n=3)$.

and the _Hauptvermutung_ is held for $3$-manifold, __i.e.__ If the complexes $K_1,$ $K_2$ are homeomorphic $3$-manifolds, then they are combinatorially equivalent, they share some isomorphic simplicial subdivisions.

$\Longrightarrow$  Every combinatorial invariant is a topological invariant.
...
* 1000 - 1040: 출근 찍자마자 방향을 돌려 투표하러 감

* 1040 - 1200: 젤다 구경 ㅎㅎ..

* 1200 - 1220: 잤다가 수취불명 전화받고 깸

* 1220 - 1400: 다시 잠

* 1400 - 1600: 주차 의견서 제출 + 노가리

* 1600 - 1830: 공부 + 생각한다는 핑계로 누워있기도 하긴 함..

* 1830 - 1910: 스테이크 구워먹음

* 1910 - 1935: 드디어 등교(오토가 번역 일거리 준댔음)

* 1935 - 2025: 교수님 기다리면서 하고 싶은거 다 하는 중(Horizon에서 확률만화 보기, triangulablity of $3$-mfds)

* 2025 - 2105: 번역! (9시까지!)

* 2105 - 2117: 낮에 받은 모르는 번호 뒷조사.. 실패

* 2117 - 2308: Traingulablity 부터 다시

* 2308 - 2328: 전화연결은 들어야지
