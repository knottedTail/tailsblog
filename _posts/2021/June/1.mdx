...
* 1000 - 1030: 출근! 미팅 준비를 시작하지 + 프로젝트 계획서 출력하려다가 점심에 출력하기로 함

* 1030 - 1047: clinical factor / ECG db 비교 쥬피터 온 + 경수 과제기간 답변 + 경수 기말 식권 메일 전달

* 1047 - 1100: 산책 겸 커피사러

* 1100 - 1145: DB importing etc.

* 1145 - 1150| DB 표 만듦(in the notebook) Rows/Cols 기재 

* 1150 - 1202: 계획서를 뽑을 타이밍(2부)

* 1202 - 1307: patient ID 관련 DB 조사중..

* 1307 - 1337: 쉬다옴

* 1337 - 1450: 계획서 정독(기관별 연구목표 전까지) + 기절

* 1450 - 1930: Gatekeeper meeting with Yonsei and Wonsei (and ByungChang)

* 1930 - 2155: 저녁 (가라아게 10p) + 미팅 결과 정리 메일.. 및 질문 메일 + 산책

* 2155 - 2235: 피드백 파일 새로고침 + 폰 하면서 쉬었습니다

* 2235 - 2312: Torsion 들여다보기
