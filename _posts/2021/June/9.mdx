...
* 1030 - 1300: Ray[tune] with AGE regression 코드 잠깐 작성 + 잠깐 오토 + 훈련소 수다(태진이형, 상준선배)

* 1300 - 1340: 수다 (정호형 재민이형 태진이형)

* 1340 - 1502: Ray tuning for age regression (FCNN)

* 1502 - 2030: Meeting w/ Medifarm + 오레오랑 소시지 꼬치 사먹음

* 2030 - 2050: Age regression: Best performance model test .. It sucks so I ran training again with sum loss function.

* 2050 - 2100: Torsion :D 전에 이닦고 잠깐 쉼

* 2100 - 2309: 이 숱한 밤들을 마음껏 만끽하고 싶은,
