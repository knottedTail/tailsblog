...
* 1000 - 1330: 출근 + 모범답안 마저 작성 + 5번 수정까지
...
* 1930 - 2005: 경수 답안 입력 안하고 쉼

* 2005 - 2030: 경수 답안 입력 하려는데 수특 문의 + 점수 수정 및 피드백파일 재업로드

* 2030 - 2309: 경수 답안 입력(10번까지) + 모두 시간을 어떻게 사용할지 알고 있는 것 같다 나만 갈피를 잡지 못하는 것 같아 마음에 들지 않는,
