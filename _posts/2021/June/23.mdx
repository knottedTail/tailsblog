...
* 1000 - 1030: 출근 +  저는 쓰레기입니다

* 1030 - 1115: ECG 모듈 문서화 관련 정리 및 연구실에 메일 + homopic covering 코멘트 참고하여 수정

* 1115 - 1120: 경수 교과서 반납 / 식권 루팅

* 1120 - 1730: 열무비빔밥! 먹다 성은 누나가 발견 + 병창씨와 교류 + 정호형 재민이형 잠깐 놀러옴

* 1730 - 1820: ... 모르겠다 차돌짬뽕 짜므라이스(짜장오므)

* 1820 - 1905: 간식챙겨먹기 + 아웃바운드 신청 자료 구경

* 1905 - 2030: 모듈만들기 + 낮잠

* 2030 - 2205: 이어서 모듈 만들기 .. 어렵다

* 2205 - 2309: 모듈 마저 보면서 별밤 + 학생의 선택을 이제는 응원을 해주어야할 것 같은,
