...
* 1000 - 1050: 출근 + 도서관에서 python 책 구경

* 1050 - 1145: diagram drawing 잠깐 수정

* 1145 - 1255: 아웃바운드 보안 서류 관련 문서 작성 및 정철호 선생님께 문의

* 1255 - 1450: 세미나 (How to find problems? + Fields we should/can learn)

* 1450 - 1745: 패키지 뒤적

* 1745 - 1830: 저녁

* 1830 - 2100: Torsion -> 효진 누나 성은 누나랑 수다로 바뀜

* 2100 - 2309: 지난 연애로 지금의 연애가 불안하지 않는,
