...
* 1600 - 1700: 도저히 못 견디겠어서 졸면서 unimodality check

* 1700 - 1820: 마저 체크 + 연구실로!

* 1820 - 2025: unimodality 보면서 노가리

* 2025 - 2308: lk4 접속 안됨ㅜㅜ + palindromic과 unimodal을 합친 Lambda poly + unimodality 함수를 어떻게 만든건지 기겁하며 재확인중 + 재확인 및 다시 체크 Riley가 unimodal 하지 않은 경우가 존재하긴 한다. + 내가 아무것도 하지 않으면 아무것도 변하지 않을걸 되새기며,
