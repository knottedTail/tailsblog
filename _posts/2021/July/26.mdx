...
* 0957 - 1023: 출근 + 송금 + 노래 구경 etc.

* 1023 - 1122: Density theorem 를 보려다 TDA Ref 구경으로 빠짐

* 1122 - 1145: Cat (for working~)

* 1145 - 1215: 단잠

* 1215 - 1515: 점심 (성은누나)

* 1515 - 1555: 하던 category 정리 .. 못하고 낮잠

* 1555 - 1750: 이제야 알듯 말듯

* 1750 - 1819: RAPIDS.ai (for UMAP+GPU) 설치 찾아보는 중 .. conda install 너무 느리다

* 1819 - 1945: 가상환경 설치하면서 놀자판 :D

* 1945 - 2308: Survay for "triangulation" + 각자의 고요함이 치열하게 맞닿는 이 밤,
