...
* 1000 - 1024: 페퍼톤스 신곡 체크하면서 노가리

* 1024 - 1122: AATRN 구경 및 노가리

* 1122 - 1208: pH 4 biological image 눈감고 듣기 + 정철호 선생님께 지난 주 서버 사용 상황 보고

* 1208 - 1310: 검진하이 취소 + Bregman div. w/ pH tutorial (Hanka) + NSW thm(reach thing) + mapper tutorial 구경 + 노가리

* 1310 - 1324: Locality of data space

* 1324 - 1450: UMAP 결과 scattering 하고 구경, 3d UMAP 세팅 시작 + 웹툰보고 잠깐 쉼

* 1450 - 1525: plotly 나올때까지 눈 감고 local VR homology  보니까 시간 순삭..?

* 1525 - 1715: plotly로 3d umap 구경 + 아이디어 없나 생각하다 산책 + 3d clustering 시도 중.. 하지만 실패(DBSCAN & OPTICS)

* 1715 - 2030: 도서관 놀러가기

* 2030 - 2150: 밥먹고 쉼 (리츠 레몬 1상자 + 김치라면)

* 2150 - 2205: 쉬었다

* 2205 - 2308: 별밤 + Teichmuller theory + 예상치 못한 일이었으니 불만이 생길법도 했지만 그래도 얻은게 있던 밤,
